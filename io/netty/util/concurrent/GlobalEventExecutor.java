...
extends AbstractEventExecutor {
    ...
    static /* synthetic */ AtomicBoolean access$200(GlobalEventExecutor x0) {
        return x0.started;
    }
...

            {
                block4: {
                    ...
                    try {
                        ...
                        GlobalEventExecutor.access$100().warn("Unexpected exception from the global event executor: ", t);
                    }
                    if (task != GlobalEventExecutor.this.purgeTask) ** GOTO lbl-1000
                }
                if (!GlobalEventExecutor.this.taskQueue.isEmpty() || GlobalEventExecutor.this.delayedTaskQueue.size() != 1) ** GOTO lbl-1000
                stopped = GlobalEventExecutor.access$200(GlobalEventExecutor.this).compareAndSet(true, false);
                ...
                return;
            } while (GlobalEventExecutor.access$200(GlobalEventExecutor.this).compareAndSet(false, true));
        }
    }
}
