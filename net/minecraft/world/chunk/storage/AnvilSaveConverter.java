    ...
    public List<SaveFormatComparator> getSaveList() throws AnvilConverterException {
        if (this.savesDirectory != null && this.savesDirectory.exists() && this.savesDirectory.isDirectory()) {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                long i2 = 0L;
                list.add(new SaveFormatComparator(s, s1, worldinfo.getLastTimePlayed(), i2, worldinfo.getGameType(), flag, worldinfo.isHardcoreModeEnabled(), worldinfo.areCommandsAllowed()));
            }
            return list;
        }
