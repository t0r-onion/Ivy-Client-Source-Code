...
public class PotionHelper {
    ...
    public static List<PotionEffect> getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
        ...
        for (int i = 0; i < n; ++i) {
            int i2;
            String s;
            Potion potion = arrpotion[i];
            if (potion == null || potion.isUsable() && !p_77917_1_ || (s = potionRequirements.get(potion.getId())) == null || (i2 = PotionHelper.parsePotionEffects(s, 0, s.length(), p_77917_0_)) <= 0) continue;
            int j = 0;
            ...
            PotionEffect potioneffect = new PotionEffect(potion.getId(), i2, j);
            if ((p_77917_0_ & 0x4000) != 0) {
