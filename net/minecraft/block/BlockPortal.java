...
extends BlockBreakable {
    ...
    public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
        ...
        int n = arraxisDirection.length;
        for (int i = 0; i < n; ++i) {
            EnumFacing.AxisDirection enumfacing$axisdirection = arraxisDirection[i];
            ...
            for (int i2 = 0; i2 < blockportal$size.func_181101_b(); ++i2) {
                for (int j = 0; j < blockportal$size.func_181100_a(); ++j) {
                    BlockWorldState blockworldstate = blockpattern$patternhelper.translateOffset(i2, j, 1);
