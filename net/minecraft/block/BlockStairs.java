...
extends Block {
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        double d1 = 0.0;
        MovingObjectPosition[] arrmovingObjectPosition = amovingobjectposition;
        int n2 = amovingobjectposition.length;
        for (int j = 0; j < n2; ++j) {
            double d0;
            MovingObjectPosition movingobjectposition = arrmovingObjectPosition[j];
