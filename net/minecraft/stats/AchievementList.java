...
public class AchievementList {
    ...
    static {
        ...
        thanksforbuying = new Achievement("achievement.thanks", "thanks", -2, 0, new ItemStack(Items.gold_ingot), null).registerStat();
        openInventory = new Achievement("achievement.openInventory", "openInventory", 0, 0, Items.book, null).registerStat();
