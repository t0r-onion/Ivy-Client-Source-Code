...
extends CommandBase {
    ...
    protected void joinTeam(ICommandSender p_147190_1_, String[] p_147190_2_, int p_147190_3_) throws CommandException {
        block7: {
            ...
            if (!(p_147190_1_ instanceof EntityPlayer) || p_147190_3_ != p_147190_2_.length) ** GOTO lbl35
...
lbl-1000:
            ...
            {
                block8: {
                    if (!(s1 = p_147190_2_[p_147190_3_++]).startsWith("@")) break block8;
                    var10_11 = CommandScoreboard.func_175763_c(p_147190_1_, s1).iterator();
                    ** GOTO lbl34
                }
...
lbl35:
    ...
    protected void leaveTeam(ICommandSender p_147199_1_, String[] p_147199_2_, int p_147199_3_) throws CommandException {
        block7: {
            ...
            set = Sets.newHashSet();
            set1 = Sets.newHashSet();
            if (!(p_147199_1_ instanceof EntityPlayer) || p_147199_3_ != p_147199_2_.length) ** GOTO lbl34
...
lbl-1000:
            ...
            {
                block8: {
                    if (!(s = p_147199_2_[p_147199_3_++]).startsWith("@")) break block8;
                    var9_10 = CommandScoreboard.func_175763_c(p_147199_1_, s).iterator();
                    ** GOTO lbl33
                }
