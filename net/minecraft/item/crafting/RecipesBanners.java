        ...
        private TileEntityBanner.EnumBannerPattern func_179533_c(InventoryCrafting p_179533_1_) {
            for (TileEntityBanner.EnumBannerPattern tileentitybanner$enumbannerpattern : TileEntityBanner.EnumBannerPattern.values()) {
                block19: {
                    block18: {
                        block17: {
                            if (!tileentitybanner$enumbannerpattern.hasValidCrafting()) continue;
                            flag = true;
                            if (!tileentitybanner$enumbannerpattern.hasCraftingStack()) break block17;
                            flag1 = false;
                            flag2 = false;
                            i = 0;
                            ** GOTO lbl30
                        }
                        if (p_179533_1_.getSizeInventory() != tileentitybanner$enumbannerpattern.getCraftingLayers().length * tileentitybanner$enumbannerpattern.getCraftingLayers()[0].length()) break block18;
                        j = -1;
                        k = 0;
                        ** GOTO lbl53
                    }
...
lbl-1000:
                    ...
                    {
                        itemstack = p_179533_1_.getStackInSlot(i);
...
lbl-1000:
...

                    {
                        l = k / 3;
                        i1 = k % 3;
                        itemstack1 = p_179533_1_.getStackInSlot(k);
