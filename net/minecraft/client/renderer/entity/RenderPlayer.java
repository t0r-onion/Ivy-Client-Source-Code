...
import clientname.cosmetics.CosmeticCap;
import clientname.cosmetics.CosmeticCape;
import clientname.cosmetics.CosmeticCape2;
import clientname.cosmetics.CosmeticCape3;
import clientname.cosmetics.CosmeticCape4;
import clientname.cosmetics.CosmeticGhostWings;
import clientname.cosmetics.CosmeticHalo;
import clientname.cosmetics.CosmeticHat;
import clientname.cosmetics.CosmeticWings;
import clientname.cosmetics.CosmeticWitchHat;
...
extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    public RenderPlayer(RenderManager renderManager, boolean useSmallArms) {
        ...
        this.addLayer(new CosmeticCap(this));
        this.addLayer(new CosmeticCape2(this));
        this.addLayer(new CosmeticCape3(this));
        this.addLayer(new CosmeticCape4(this));
        this.addLayer(new CosmeticHalo(this));
        this.addLayer(new CosmeticHat(this));
        this.addLayer(new CosmeticGhostWings(this));
