...
extends Render<EntityItem> {
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        if (Client.ItemPhysics) {
            ...
            if (!flag) {
                float f62 = -0.0f * (float)(i - 1) * 0.5f;
                float f4 = -0.0f * (float)(i - 1) * 0.5f;
                float f5 = -0.046875f * (float)(i - 1) * 0.5f;
                GlStateManager.translate(f62, f4, f5);
            }
        ...
        GlStateManager.translate((float)p_177077_2_, (float)p_177077_4_ + f1 + 0.25f * f2, (float)p_177077_6_);
        if (flag || this.renderManager.options != null) {
            f62 = (((float)itemIn.getAge() + p_177077_8_) / 20.0f + itemIn.hoverStart) * 57.295776f;
        }
        if (!flag) {
            f62 = -0.0f * (float)(i - 1) * 0.5f;
            float f4 = -0.0f * (float)(i - 1) * 0.5f;
            float f5 = -0.046875f * (float)(i - 1) * 0.5f;
            if (itemIn.onGround) {
        ...
        float speed = 10.0f;
        if (!itemIn.onGround) {
            float rotAmount = (float)itemIn.getAge() * speed % 360.0f;
