        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.isRenderEntityOutlines()) {
                ...
                for (int j = 0; j < list.size(); ++j) {
                    ...
                    boolean bl = flag1 = entity3.isInRangeToRender3d(d0, d1, d2) && (entity3.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(entity3.getEntityBoundingBox()) || entity3.riddenByEntity == this.mc.thePlayer) && entity3 instanceof EntityPlayer;
                    if (entity3 == this.mc.getRenderViewEntity() && this.mc.gameSettings.thirdPersonView == 0 && !flag || !flag1) continue;
            ...
            for (ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation : this.renderInfos) {
                ...
                for (Entity entity2 : classinheritancemultimap) {
                    boolean flag2;
                    boolean bl = flag2 = this.renderManager.shouldRender(entity2, camera, d0, d1, d2) || entity2.riddenByEntity == this.mc.thePlayer;
                    if (flag2) {
                        boolean flag3;
                        ...
                        if (entity2 == this.mc.getRenderViewEntity() && this.mc.gameSettings.thirdPersonView == 0 && !flag3 || !(entity2.posY < 0.0) && !(entity2.posY >= 256.0) && !this.theWorld.isBlockLoaded(new BlockPos(entity2))) continue;
                        ++this.countEntitiesRendered;
            ...
            Set<TileEntity> renderglobal$containerlocalrenderinformation1 = this.field_181024_n;
            synchronized (renderglobal$containerlocalrenderinformation1) {
    ...
    public void playAuxSFX(EntityPlayer player, int sfxType, BlockPos blockPosIn, int p_180439_4_) {
        ...
        switch (sfxType) {
            ...
            case 2003: {
                ...
                for (double d18 = 0.0; d18 < Math.PI * 2; d18 += 0.15707963267948966) {
