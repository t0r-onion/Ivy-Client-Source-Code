...
IStream {
    ...
    public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
        ChatRawMessage[] arrchatRawMessage = p_180605_2_;
        int n = p_180605_2_.length;
        for (int i = 0; i < n; ++i) {
            ChatRawMessage chatrawmessage = arrchatRawMessage[i];
    ...
    public void func_176018_a(String p_176018_1_, ChatUserInfo[] p_176018_2_, ChatUserInfo[] p_176018_3_, ChatUserInfo[] p_176018_4_) {
        int n;
        ChatUserInfo[] arrchatUserInfo = p_176018_3_;
        int n2 = p_176018_3_.length;
        for (n = 0; n < n2; ++n) {
            ChatUserInfo chatuserinfo = arrchatUserInfo[n];
            this.field_152955_g.remove(chatuserinfo.displayName);
        }
        arrchatUserInfo = p_176018_4_;
        n2 = p_176018_4_.length;
        for (n = 0; n < n2; ++n) {
            ChatUserInfo chatuserinfo1 = arrchatUserInfo[n];
            this.field_152955_g.put(chatuserinfo1.displayName, chatuserinfo1);
        }
        arrchatUserInfo = p_176018_2_;
        n2 = p_176018_2_.length;
        for (n = 0; n < n2; ++n) {
            ChatUserInfo chatuserinfo2 = arrchatUserInfo[n];
