...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (!ModPerspective.perspectiveToggled && this.showCrosshair()) {
            ...
            GuiIngame.drawTexturedModalRect(i / 2 - 7, j / 2 - 7, 0, 0, 16, 16);
        }
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (entity == null) {
                ...
                for (int k6 = 0; k6 < 10; ++k6) {
                    ...
                    int i9 = j1 - k6 * 8 - 9;
                    GuiIngame.drawTexturedModalRect(i9, i7, 16 + j8 * 9, 27, 9, 9);
                    if (flag1) {
                        if (k6 * 2 + 1 < l) {
                            GuiIngame.drawTexturedModalRect(i9, i7, l7 + 54, 27, 9, 9);
                        }
                        if (k6 * 2 + 1 == l) {
                            GuiIngame.drawTexturedModalRect(i9, i7, l7 + 63, 27, 9, 9);
                        }
                    }
                    if (k6 * 2 + 1 < k) {
                        GuiIngame.drawTexturedModalRect(i9, i7, l7 + 36, 27, 9, 9);
                    }
                    if (k6 * 2 + 1 != k) continue;
                    GuiIngame.drawTexturedModalRect(i9, i7, l7 + 45, 27, 9, 9);
                }
                ...
                while (k8 > 0) {
                    ...
                    for (int i5 = 0; i5 < l4; ++i5) {
                        ...
                        int l5 = j1 - i5 * 8 - 9;
                        GuiIngame.drawTexturedModalRect(l5, j9, j5 + k5 * 9, 9, 9, 9);
                        if (i5 * 2 + 1 + k9 < j7) {
                            GuiIngame.drawTexturedModalRect(l5, j9, j5 + 36, 9, 9, 9);
                        }
                        if (i5 * 2 + 1 + k9 != j7) continue;
                        GuiIngame.drawTexturedModalRect(l5, j9, j5 + 45, 9, 9, 9);
                    }
                    j9 -= 10;
                    k9 += 20;
                }
