...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        GameSettings.Options[] arroptions = field_152312_a;
        int n2 = field_152312_a.length;
        for (n = 0; n < n2; ++n) {
            GameSettings.Options gamesettings$options = arroptions[n];
        ...
        i += 2;
        arroptions = field_152316_f;
        n2 = field_152316_f.length;
        for (n = 0; n < n2; ++n) {
            GameSettings.Options gamesettings$options1 = arroptions[n];
