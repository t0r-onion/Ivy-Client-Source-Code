...
IPlayerUsage {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle((String)Client.ClientName);
        try {
    ...
    private void runGameLoop() throws IOException {
        ...
        while (Minecraft.getSystemTime() >= this.debugUpdateTime + 1000L) {
            debugFPS = this.fpsCounter * Client.FPSBoost;
    ...
    public void runTick() throws IOException {
        block97: {
            block98: {
                ...
                if (this.currentScreen != null && !this.currentScreen.allowUserInput) break block97;
