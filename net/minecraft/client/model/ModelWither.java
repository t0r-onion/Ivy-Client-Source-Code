...
extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        ModelRenderer[] arrmodelRenderer = this.field_82904_b;
        int n2 = this.field_82904_b.length;
        for (n = 0; n < n2; ++n) {
            ModelRenderer modelrenderer = arrmodelRenderer[n];
            modelrenderer.render(scale);
        }
        arrmodelRenderer = this.field_82905_a;
        n2 = this.field_82905_a.length;
        for (n = 0; n < n2; ++n) {
            ModelRenderer modelrenderer1 = arrmodelRenderer[n];
